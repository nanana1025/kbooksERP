...
<%--                         <td>${db_password}</td> --%>
					...
					<%--<tr>--%>
						<%--<th>--%>
							<%--<label for="adminPwConf">관리자PW확인</label>--%>
						<%--</th>--%>
						<%--<td>--%>
							<%--<input type="password" id="adminPwConf" name="adminPwConf"  class="k-textbox" required validationMessage="관리자Password확인은 필수 항목입니다.">--%>
						<%--</td>--%>
					<%--</tr>--%>
					<tr>
						<th>
							<label for="copyright">copywrite</label>
						</th>
						<td>
							<textarea id="copyright" name="copyright"  class="k-textbox"  rows="5" style="width: 100%;">${systemInfo.COPYRIGHT}</textarea>
							<%--<input type="text" id="copyright" name="copyright"  class="k-textbox" value="${systemInfo.COPYRIGHT}">--%>
						</td>
					</tr>
					<tr>
						<th>
