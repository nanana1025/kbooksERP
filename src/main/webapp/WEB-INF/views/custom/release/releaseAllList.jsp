	...
	$("<div></div>").kendoConfirm({
		...
		actions: [{
			...
			action: function(e){
				...
				console.log("selItem.release_dt == " +selItem.release_dt == "");
				console.log("selItem.release_dt" +selItem.release_dt);


				if(selItem.release_dt == null || selItem.release_dt == "")
					params.RELEASE_DT_YN = "N";
				else
					params.RELEASE_DT_YN = "Y";
