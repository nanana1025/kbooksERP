...
//  		var openerGrid = opener.$('#admin_produce_warehousing_all_list_gridbox').data('kendoGrid');
...
// 		console.log("_warehousingId = "+_warehousingId);
// 		console.log("_warehousing = "+_warehousing);
