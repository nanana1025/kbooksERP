...
$(document).ready(function() {
	...
	console.log("load [companyConsignedInventoryAll.js]");
...
function fnShowAll(){
	...
	var url = "&pid=${sid}&CUSTOMKEY=COMPANY_ID,WAREHOUSING_TYPE,INVENTORY_TYPE&CUSTOMVALUE="+params.COMPANY_ID+",2,C";

	fnWindowOpen("/layoutNewList.do?xn=company_Consigned_Inventory_Popup_LAYOUT"+url,"component_id", "L");
