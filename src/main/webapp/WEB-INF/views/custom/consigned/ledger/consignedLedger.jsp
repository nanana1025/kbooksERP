...
$(document).ready(function() {
	...
	console.log("load [consignedLedger.js]");
	// $('.basicBtn').remove();
	...
	var infCondDate ='<button id="btnGoReceiptList" onclick="fnGoReceiptList()" class="k-button" style="float: left; width: 40px; background-color: slategray; margin-top:5px;margin-left:10px; padding: 3px 7px 3px 7px; font-size: 12px;">\
		<span class="k-icon k-i-paste-plain-text" style="float: right; font-size: 18px; color: white;"></span>\
		</button>\
		<div style="border: 0px solid gold; float: left; width: 85%;">\
	...
	<tr style="" class="">\
		...
		<td style="text-align:right;" width="50px">고객명</td>\
	...
	<div style="border: 0px solid gold; float: left; width: 4%;">\
			<button id="consigned_search" onclick="fnConsignedData()" class="k-button" data-role="button" role="button" aria-disabled="false" tabindex="1" style="margin-top: 5px; margin-left: 20px;">검색</button>\
</div>';

	$('#consigned_ledger_list_Joborder_printBtn').css('float', 'right');
	 $('#consigned_ledger_list_Joborder_printBtn').css('margin-top', '5px');
    $('#consigned_ledger_list_printBtn').css('margin-top', '5px');
    $('#consigned_ledger_list_printBtn').css('float', 'right');
    $('#consigned_ledger_list_printBtn').text("리스트 출력")
...
//      change: fnDropBoxonChange
	...
	setTooltipOnIcon($("[id*='btnGoReceiptList"), "접수리스트");
