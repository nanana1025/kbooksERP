...
<c:url var="companyComponentVisibleChange"					value="/consigned/companyComponentVisibleChange.json" />
...
function fnComponentVisible(visibleYn){
	...
	var url = '${companyComponentVisibleChange}';
	...
	var params = {
			COMPANY_COMPONENT_ID : selItem.company_component_id,
