...
//  var _CPUNAME = ["제조사","모델명","상세스펙"] ;
//  var _MBDNAME = ["제조사","모델명","상세스펙"] ;
//  var _MEMNAME = ["제조사","모델명","용량"] ;
//  var _STGNAME = ["제조사","모델명","용량"] ;
//  var _VGANAME = ["제조사","모델명","용량"] ;
//  var _MONNAME = ["제조사","모델명","사이즈"] ;
