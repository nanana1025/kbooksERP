...
function fnSelectComponent(){
		...
		fnWindowOpen_LTComponent("/layoutNewList.do?xn=consignedSelect_Component_LAYOUT","component_id","W");
}
...
function fnWindowOpen_LTComponent(url, callbackName, size) {
    ...
    window.open("<c:url value='"+url+"'/>"+"&COMPANY_ID="+_companyid+"&callbackName="+callbackName+"&CUSTOMKEY=COMPANY_ID&CUSTOMVALUE="+_companyid, "selectConsignedComponent", "top="+yPos+", left="+xPos+", width="+width+", height="+height);
}
