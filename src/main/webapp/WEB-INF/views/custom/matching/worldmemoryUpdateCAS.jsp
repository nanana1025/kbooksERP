...
function fnCancle(){
	console.log("load [fnCancle.js]");
	 ...
	 $('#cancelbtn_admin_component_matching_cas_list').kendoButton();
     var cancelBtn = $('#cancelbtn_admin_component_matching_cas_list').data('kendoButton');
...
function SetInitDate(){
	...
	var grid = opener.$('#admin_component_matching_cas_list_gridbox').data('kendoGrid');
	...
	$('#CASE_TYPE').val(params.CASE_TYPE);
