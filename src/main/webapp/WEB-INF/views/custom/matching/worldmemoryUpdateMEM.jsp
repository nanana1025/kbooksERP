...
function fnCancle(){
	console.log("load [fnCancle.js]");
	 ...
	 $('#cancelbtn_admin_component_matching_mem_list').kendoButton();
     var cancelBtn = $('#cancelbtn_admin_component_matching_mem_list').data('kendoButton');
...
function SetInitDate(){
	...
	var grid = opener.$('#admin_component_matching_mem_list_gridbox').data('kendoGrid');
    ...
    $('#BANDWIDTH').val(params.BANDWIDTH);
