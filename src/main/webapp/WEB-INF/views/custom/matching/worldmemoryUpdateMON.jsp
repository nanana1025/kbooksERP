...
function fnCancle(){
	console.log("load [fnCancle.js]");
	 ...
	 $('#cancelbtn_admin_component_matching_mon_list').kendoButton();
     var cancelBtn = $('#cancelbtn_admin_component_matching_mon_list').data('kendoButton');
...
function SetInitDate(){
	...
	var grid = opener.$('#admin_component_matching_mon_list_gridbox').data('kendoGrid');
    ...
    $('#RESOLUTION').val(params.RESOLUTION);
