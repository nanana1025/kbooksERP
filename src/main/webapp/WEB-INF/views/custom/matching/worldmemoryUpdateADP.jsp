...
function fnCancle(){
	console.log("load [fnCancle.js]");
	 ...
	 $('#cancelbtn_admin_component_matching_adp_list').kendoButton();
     var cancelBtn = $('#cancelbtn_admin_component_matching_adp_list').data('kendoButton');
...
function SetInitDate(){
	...
	var grid = opener.$('#admin_component_matching_adp_list_gridbox').data('kendoGrid');
	...
	$('#OUTPUT_WATT').val(params.OUTPUT_WATT);
    $('#CLASS_NM').val(params.CLASS_NM);
