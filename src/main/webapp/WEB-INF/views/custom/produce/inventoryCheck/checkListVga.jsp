...
<html>
	...
	<style type="text/css">
	    ...
	    .tg .tg-buh44{background-color:#f9f9f9;text-align:left;vertical-align:center; width:470px;}
...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> VGA 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">VGA</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">VGA</td>
        <td class="tg-buh44">
           <table >
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
	                ...
	                <input type="checkbox" name="결함1" value="2" /> FAN 파손
	                <input type="checkbox" name="결함2" value="4" /> FAN 소음
	                <input type="checkbox" name="결함3" value="8" /> RGB 인식 안됨
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함4" value="16" /> DVI 인식 안됨
	                <input type="checkbox" name="결함5" value="32" /> HDMI 인식 안됨
	                <input type="checkbox" name="결함6" value="64" /> DP 인식 안됨
	            	</form>
	        	</td>
        	</tr>
        	</table>
