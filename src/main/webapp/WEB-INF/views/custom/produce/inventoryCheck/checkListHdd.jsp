...
<html>
	...
	<style type="text/css">
	    ...
	    .tg .tg-buh44{background-color:#f9f9f9;text-align:left;vertical-align:center; width:500px;}
...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> HDD 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">HDD</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">HDD</td>
        <td class="tg-buh44">
            <form>
                <input type="checkbox" name="결함0" value="1" /> MAIN PCB 파손
                <input type="checkbox" name="결함1" value="2" /> 배드 섹터 주의
                <input type="checkbox" name="결함2" value="4" /> 배드 섹터 위험
                <input type="checkbox" name="결함3" value="8" /> 디스크 소음
