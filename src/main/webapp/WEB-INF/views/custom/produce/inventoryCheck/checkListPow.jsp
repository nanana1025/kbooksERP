...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> POW 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">POW</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">POW</td>
        <td class="tg-buh44">
            <form>
                <input type="checkbox" name="결함0" value="1" /> PG 오류
                <input type="checkbox" name="결함1" value="2" /> FAN 소음
