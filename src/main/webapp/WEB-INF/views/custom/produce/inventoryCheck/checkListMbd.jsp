...
<c:url var="InventoryCheckForWeb"							value="/inventoryCheck/InventoryCheckForWeb.json" />
...
<html>
	...
	<style type="text/css">
	    ...
	    .tg .tg-buh4{background-color:#f9f9f9;text-align:center;vertical-align:middle;width: 70px;}
	    .tg .tg-buh44{background-color:#f9f9f9;text-align:left;vertical-align:center; width:600px;}
	     .tg .tg-buh444{background-color:#f9f9f9;text-align:left;vertical-align:middle;width: 70px;}
	    .tg .tg-0lax{text-align:left;vertical-align:top}
	    .tg .tg-yjjc{background-color:#f9f9f9;text-align:center;vertical-align:middle}
	    .tg .tg-shlee{
...
// 			contentType: "application/json",
	...
	function dataInitialize(data)
	{
		...
		VARIABLE[0] = data.FAULT * 1; //FAULT

		for(var i = 0 ; i < _NAME.length; i++){
			for(var j = 0 ; j < _faultCnt; j++){
				var id = "input:checkbox[name='"+_NAME[i]+j+"']";
				if((VARIABLE[i] & _BCASE[j]) == _BCASE[j])
...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> 메인보드 검수</H2>
<table class="tg">
    <thead>
    <tr>
        <th class="tg-0lax"><b>제품코드</th>
        <th class="tg-0lax"><b>단계</th>
        <th class="tg-0lax"><b>항목</th>
        <th class="tg-0lax"><b>세부항목</th>
    </tr>
    </thead>
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">메인보드</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">메인보드</td>
        <td class="tg-buh44">
           <table >
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함0" value="1" /> MAIN PCB 파손
	                <input type="checkbox" name="결함1" value="2" /> CPU PIN 휨
	                <input type="checkbox" name="결함2" value="4" /> RAM 슬롯 인식 안됨
	                <input type="checkbox" name="결함3" value="8" /> RAM 슬롯 파손
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함4" value="16" /> VGA 슬롯 인식 안됨
	                <input type="checkbox" name="결함5" value="32" /> VGA 슬롯 파손
	                <input type="checkbox" name="결함6" value="64" /> SATA 포트 인식 안됨
	                <input type="checkbox" name="결함7" value="128" /> SATA 포트 파손
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함8" value="256" /> M.2/mSATA 포트 인식 안됨
	                <input type="checkbox" name="결함9" value="512" /> M.2/mSATA 토프 파손
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함10" value="1024" /> USB 인식 안됨
	                <input type="checkbox" name="결함11" value="2048" /> USB 포트 파손
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함12" value="4096" /> LAN 포트 인식 안됨
	                <input type="checkbox" name="결함13" value="8192" /> LAN 포트 파손
	            	</form>
	        	</td>
        	</tr>
        	<tr>
	        	<td class="tg-buh444 tg-shlee">
		        	<form>
	                <input type="checkbox" name="결함14" value="16384" /> 사운드 포트 인식 안됨
	                <input type="checkbox" name="결함15" value="32768" /> 사운드 포트 파손
	            	</form>
	        	</td>
        	</tr>
        	</table>
