...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> SSD 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">SSD</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">SSD</td>
        <td class="tg-buh44">
            <form>
                <input type="checkbox" name="결함0" value="1" /> CRC 오류
