...
<c:url var="MonitorCheckForWeb"							value="/inventoryCheck/MonitorCheckForWeb.json" />
...
// 			contentType: "application/json",
	...
	function dataInitialize(data)
	{
		...
		var port;
			...
			port = data.PORT * 1; //cam
			VARIABLE[1] = data.ADAPTER * 1;	//adapter
			...
			for(var i = 0 ; i < 4; i++){
				var id = "input:checkbox[name='포트"+i+"']";
				if((port & _BCASE[i]) == _BCASE[i])
					$(id).prop("checked", true);
			}
...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> 모니터 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
        <td class="tg-yjjc" rowspan="4">모니터</td>
    ...
    <tr>
        <td class="tg-0lax">2단계</td>
        <td class="tg-0lax">액정</td>
        <td class="tg-0lax">
            <form>
    ...
    <tr>
        <td class="tg-buh4">3단계</td>
        <td class="tg-buh4">포트</td>
        <td class="tg-buh4">
                <input type="checkbox" name="포트0" value="1" /> RGB 인식안됨
                <input type="checkbox" name="포트1" value="2" /> DVI 인식안됨
                <input type="checkbox" name="포트2" value="4" /> HDMI인식안됨
                <input type="checkbox" name="포트3" value="8" /> DP인식안됨
       	</td>
    </tr>
    <tr>
        <td class="tg-0lax">4단계</td>
        <td class="tg-0lax">아답터</td>
        <td class="tg-0lax">
            <form>
