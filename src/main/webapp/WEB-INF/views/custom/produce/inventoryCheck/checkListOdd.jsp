...
<html>
	...
	<style type="text/css">
	    ...
	    .tg .tg-buh44{background-color:#f9f9f9;text-align:left;vertical-align:center; width:300px;}
...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> ODD 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">ODD</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">ODD</td>
        <td class="tg-buh44">
            <form>
                <input type="checkbox" name="결함0" value="1" /> 인식 안됨
                <input type="checkbox" name="결함1" value="2" /> CD 읽기 안됨
                <input type="checkbox" name="결함2" value="4" /> DOOR 불량
