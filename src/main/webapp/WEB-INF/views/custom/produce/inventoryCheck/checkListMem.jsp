...
<body>
<H2 style = 'margin-left: 30px; margin-top: 20px;'> 메모리 검수</H2>
<table class="tg">
    <thead>
    <tr>
    ...
    <tbody>
    <tr>
    	<td class="tg-yjjc" rowspan="2">메모리</td>
        <td class="tg-buh4">1단계</td>
        <td class="tg-buh4">메모리</td>
        <td class="tg-buh44">
            <form>
                <input type="checkbox" name="결함0" value="1" /> PCB 파손
<!--                 <input type="checkbox" name="결함1" value="2" /> PCB 파손 -->
