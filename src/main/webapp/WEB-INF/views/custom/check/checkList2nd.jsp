...
function fnProductPrint() {
	...
	var pGrid = $('#checkntb2nd_warehousing_list_gridbox').data('kendoGrid');
...
function fnProductCheck(){
	...
	var params = "WAREHOUSING_ID="+pSelItem.warehousing_id+"&INVENTORY_ID="+selItem.inventory_id+"&CHECK_TYPE="+_checkType+"&sid="+sid;
