...
function initGrid() {
	$('#admin_premiumuser_list_gridbox').off('dblclick');
	var grid = $('#admin_premiumuser_list_gridbox').data('kendoGrid');
...
function selectRow() {
	...
	if(localName == 'thead') {
		var gridElements = $("#admin_premiumuser_list_gridbox").find('tbody').children('tr');
...
function fnSendMail() {
	...
	window.open("/charging/premiumuserSendMailP.do", "premiumuserSendMailP", "top="+yPos+", left="+xPos+", width="+ width +", height="+ height +", scrollbars=1");
}
